...
public class DemoTest {
	...
	public static void main(String[] args) {
		...
		while (!p.isFinished()) {
			...
			print("correct?" + q.isCorrect());
			print("abandon?" + q.isAbandoned());
			print("allcount:" + p.getAllQuizCount());
			print("finished:" + p.getFinishedQuizCount());
			print("finishedCorrect:" + p.getFinishedCorrectQuizCount());
			print("finishedWrong:" + p.getFinishedWrongQuizCount());
			print("unfinshed:" + p.getUnfinishedQuizCount());
			pntmemuseage();
			print("=================================");
		}
		pntmemuseage();
