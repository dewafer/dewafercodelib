...
public final class ExtClasspathLoader {
    ...
    private URLClassLoader classloader = (URLClassLoader) ClassLoader
     ...
     * 取得某一类所在包的所有类名 不含迭代
     */
    private String[] getPackageAllClassName(String classLocation,
	    String packageName) {
	// 将packageName分解
	...
	try {
	    // TODO use different classLoader here
